...
namespace String_vibration_openTK.src.fe_objects
{
    public class elementfixedend_store
    {
        ...
        public elementfixedend_store(Vector2 fixedend_loc, float fixedend_angle)
        {
            ...
            Vector2 topLeft = new Vector2(-fixed_end_width / 2.0f, 0.0f);
            Vector2 topRight = new Vector2(fixed_end_width / 2.0f, 0.0f);
            Vector2 bottomLeft = new Vector2(-fixed_end_width / 2.0f, -fixed_end_width);
            Vector2 bottomRight = new Vector2(fixed_end_width / 2.0f, -fixed_end_width);
