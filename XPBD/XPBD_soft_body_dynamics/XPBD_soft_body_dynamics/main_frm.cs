...
// using XPBD_soft_body_dynamics.other_windows;
using XPBD_soft_body_dynamics.src.fe_objects;
// Local resource
    ...
    public partial class main_frm : Form
    {
       ...
       //  private setmodel_frm model_Form;
        ...
        public main_frm()
        {
            ...
            glControl_main_panel.SizeChanged += glControl_main_panel_SizeChanged;
            glControl_main_panel.MouseEnter += glControl_main_panel_MouseEnter;
            glControl_main_panel.MouseDown += glControl_main_panel_MouseDown;
            glControl_main_panel.MouseWheel += glControl_main_panel_MouseWheel;
            glControl_main_panel.MouseMove += glControl_main_panel_MouseMove;
            glControl_main_panel.MouseUp += glControl_main_panel_MouseUp;
