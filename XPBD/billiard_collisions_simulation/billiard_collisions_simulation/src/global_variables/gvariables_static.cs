using OpenTK;
using billiard_collisions_simulation.src.opentk_control.opentk_buffer;
using SharpFont;
using System;
...
namespace billiard_collisions_simulation.src.global_variables
{
    public static class gvariables_static
    {
        ...
        public static bool TryGetPositiveInteger(TextBox tb, string name, out int value)
        {
